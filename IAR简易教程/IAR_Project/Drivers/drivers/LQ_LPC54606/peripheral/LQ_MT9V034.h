...
#define SCL_PIN   P1_3   /*!< SCCB SCL 管脚 */
#define SDA_PIN   P1_2   /*!< SCCB SDA 管脚 */


#define SCL_Out   PIN_Dir(SCL_PIN, 1);      //配置输出作为SCL_Out
#define SDA_Out   PIN_Dir(SDA_PIN, 1);      //配置作为输出作为SDA_Out
#define SDA_In    PIN_Dir(SDA_PIN, 0);      //配置作为输入作为SDA_In
#define SCL_High  PIN_Write(SCL_PIN, 1);      //配置输出高电平
#define SCL_Low   PIN_Write(SCL_PIN, 0);      //配置输出低电平
#define SDA_High  PIN_Write(SDA_PIN, 1);      //配置输出高电平
#define SDA_Low   PIN_Write(SDA_PIN, 0);      //配置输出低电平
#define SDA_Data  PIN_Read(SDA_PIN)           //读取引脚上的引脚状态
